...
SECRET_KEY = 'django-insecure-u*3$j+rfv(wn2i7ury&ams$ha#cr(flcqm_=n-z&y5_-k^lk2j'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'my_library',           # Имя базы данных
        'USER': 'postgres',         # Имя пользователя
        'PASSWORD': '1234',         # Пароль (замените на ваш)
        'HOST': 'localhost',            # Хост
        'PORT': '5432',                 # Порт
    }
}
...
# Добавьте путь к вашей папке static
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
# Media files (для загрузки обложек книг)
MEDIA_URL = '/media/'
